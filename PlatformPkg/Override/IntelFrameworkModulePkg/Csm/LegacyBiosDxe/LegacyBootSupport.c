...
//HYL-2016101802-end
  ...
  LegacyEdgeLevel |= UartIrqs; //HYL-2016101802
/* //HYL-2016101802 
  ...
  )
{
  ...
  DEBUG ((EFI_D_INFO, "E820_SIZE %X -> %X\n", Private->Legacy16Table->E820Length, CopySize));
  ...
  if (Regs.X.AX != 0) {
    ...
    DEBUG ((EFI_D_INFO, "E820_DATA %X -> %X\n", Private->E820Table, Private->Legacy16Table->E820Pointer));		
  }
...
/* //HYL-2016101802
    ...
    {
      UINT16  LegacyMask, LegacyEdgeLevel;
      Private->Legacy8259->GetMask(Private->Legacy8259, &LegacyMask, &LegacyEdgeLevel, NULL, NULL);
      DEBUG((EFI_D_INFO, "8259 M:%04X L:%04X\n", LegacyMask, LegacyEdgeLevel));	
      ((BDA_STRUC*)(UINTN)0x400)->Com1 = 0;   // Do not let DOS change BR to 2400.
