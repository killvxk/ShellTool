...
#define USBLEGCTLSTS_OWNERSHIP_ENABLE      BIT13 // SMI on OS Ownership Enable
#define USBLEGCTLSTS_IOC_ENABLE            BIT0  // SMI on USB Complete Enable
#define USBSTS_PORT_CHANGE                 BIT4  // Port Change Detect (PCD)
#define USBLEGCTLSTS_OWNERSHIP             BIT29 // SMI on OS Ownership
#define XHC_PCI_MEM_BASE_ADDRESS           0x10  // Memory Bar register address
#define XHC_PCI_MEM_BASE_MASK              0x0ffffff00 // Memory address MASK
#define XHCSTS_CNR                         0x0800 // Host controller Controller Not Ready (CNR)
