    ...
    Name(AR00, Package(19)
    {
        Package(4) {0x0002FFFF, Zero, Zero, 0x20}, 
    ...
    Name(AR01, Package(4)
    {
        Package(4) {0xFFFF, Zero, Zero, 0x21}, 
        Package(4) {0xFFFF, One, Zero, 0x22}, 
        Package(4) {0xFFFF, 0x02, Zero, 0x23}, 
        Package(4) {0xFFFF, 0x03, Zero, 0x20}
    })        
