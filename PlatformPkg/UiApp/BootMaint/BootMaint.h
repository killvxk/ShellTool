...
#define VAR_LEGACY_DEV_ORDER_TEMP L"LegacyDevOrderTemp"
...
#define TEMP_VAR_FLAG  EFI_VARIABLE_BOOTSERVICE_ACCESS | EFI_VARIABLE_RUNTIME_ACCESS
...
typedef struct {
  ...
  EFI_HANDLE                     BmmSaveNotifyHandle;
...
extern STRING_DEPOSITORY          *FirstStrDepository;
...
extern BMM_CALLBACK_DATA           *BmmCallbackInfo;
